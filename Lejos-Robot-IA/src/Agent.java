...
public class Agent {
	/**
	 * @see Port
	 * le " A,B,C,D " de l'agent sont les port des differents moteurs et peut-Ítre modifiÈ</br>
	 * <p>
	 * 
	 * </p>
	 */
	 ...
	 */
	/* 
	 * l'Ètat au premier indice etat[0] est l'Ètat courant
	 * 
	 * etat n1 ; li√© √† l'automate en "dur", recupËre autant de palets que possible le plus vite possible
	 * etat n2 ; recherche en fonction de cartePalets
	 * etat n3 ; recherche al√©atoire
	 * etat n4 ; palet en possession
	 * etat n5 ; palet d√©tect√©
	 * [...] ;
	 * 
	 */
	/**
	...
	public Agent() {
		...
		System.out.println("Position de d√©part? vert/bleu");
